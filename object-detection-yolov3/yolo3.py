...
classes = open('datasets/plates.names').read().strip().split('\n')
np.random.seed(42)
colors = np.random.randint(0, 255, size=(len(classes), 3), dtype='uint8')

# Give the configuration and weight files for the model and load the network.
net = cv.dnn.readNetFromDarknet('yolov3.cfg', 'models/yolov3_last.weights')
...
load_image('1_images_test.jpg')
# load_image('images/eagle.jpg')
# load_image('images/person.jpg')
# load_image('images/scream.jpg')
